...
{
    if([self count] != 1)
        [NSException raise:NSInternalInconsistencyException format:@"-[%@ %@]: Attempt to retrieve single object from an array that contains %d objects.", NSStringFromClass(self.class), NSStringFromSelector(_cmd), [self count]];
